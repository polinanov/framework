    ...
    private function getDataFromSource(array $search = [])
    {
        $dataSource = [
            ...
            [
                ...
                'name' => 'Lua',
                'price' => 5000,
                'description' => 'Lua — скриптовый язык программирования, разработанный в подразделении Computer Graphics Technology Group католического университета Рио-де-Жанейро (Бразилия). Интерпретатор языка является свободно распространяемым, с открытыми исходными текстами на языке Си.',
            ],
            [
                'id' => 12,
                'name' => 'Rust',
